...
if (require.main === module) {
    ; (async () => {
        ...
        const dAppURI = process.env.APP_DID_URI;
        ...
        switch (step) {
            case 0: // first connect to a websocket of the chain you want to interact with:
            ...
            case 1: // then we generate an account
        ...
        // //if the webSocket is already defined:
        // if (process.env.WSS_ADDRESS && !process.env.ATTESTER_ACCOUNT_MNEMONIC) {
        //     try {
        //         const mnemonic = mnemonicGenerate();
        //         const account = generateAccount(mnemonic);
        //         console.log('\n please, save mnemonic and address to .env to continue!\n\n');
        //         console.log(`ATTESTER_ACCOUNT_MNEMONIC="${mnemonic}"`);
        //         console.log(`ATTESTER_ACCOUNT_ADDRESS="${account.address}"\n\n`);
        //         console.log('You also need to deposit funds on this account.\n For peregrine-accounts you can use: https://faucet.peregrine.kilt.io/');
        //         console.log("\nAfterwards run this file again\n");
        //     } catch (e) {
        //         console.log('Error while setting up attester account');
        //         throw e;
        //     }
        // } else if (!process.env.ATTESTER_ACCOUNT_MNEMONIC) {
        //     throw new Error("you need to define WSS_ADDRESS before generating an account");
        // };
